...
class Builder:
    ...
    def bundle(self,parents=()):
        return {'version':'hwp-a/0.3','documents':list(parents)+[self.record()],'target':self.did}
...
def permissive_fixture_model(bundle):
    ...
    return {'version':'hwp-a-model/0.3','purpose':'fixture','features':names or [],'domains':domains}
